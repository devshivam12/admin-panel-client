...
import { useGetDashboardInformationQuery } from '../../state/api'
...
const Dashboard = () => {
  const { data, isLoading } = useGetDashboardInformationQuery()
  console.log(data)
    ...
    <Box m="1.5rem 2.5rem">
      ...
      >
        ...
        <Box
          ...
          borderRadius="0.5rem"
        >
          <OverviewCharts view="sales" isDashboard={true} />
        </Box>
        ...
        >
          ...
          <Typography p="0 0.6rem" fontSize="0.8rem" sx={{
